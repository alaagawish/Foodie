            ...
            public void onClick(View v) {
                ...
                else
                {
                    if(userName.isEmpty() && email.isEmpty() && pass.isEmpty() && confirmPass.isEmpty())
                    {
                        ...
                        emailEditTextSignUp.setError("Email cannot be empty!");
                        passwordEditTextSignUp.setError("Password cannot be empty!");
                        confirmPasswordEditTextLogin.setError("Confirm password cannot be empty!");
                    }
                    if(userName.isEmpty())
                    {
                        usernameEditTextSignUp.setError("UserName cannot be empty!");
                    ...
                    {
                        confirmPasswordEditTextLogin.setError("Confirm password not correct!");
                    }
                }
            }
        });
